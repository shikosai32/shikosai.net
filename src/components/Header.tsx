  ...
  <div className="fixed top-0 z-10 h-20 w-full bg-white font-roboto_serif drop-shadow-md">
    <div className="hidden h-full w-full md:block">
      <div className="flex h-full w-full items-center justify-center space-x-8">
        ...
        <a href="./circle" rel="noopener noreferrer" className="w-24 font-semibold">
          CIRCLE
        </a>
        ...
        <a href="./timetable" rel="noopener noreferrer" className="w-24 font-semibold">
          TIMETABLE
        </a>
        <a href="./staff" rel="noopener noreferrer" className="w-24 font-semibold">
          STAFF
        </a>
      </div>
    </div>
